...
public:
    ...
    typedef touchgfx::meta::TypeList< Screen1View,
            touchgfx::meta::TypeList< ScreenSettingsView,
            touchgfx::meta::TypeList< ScreenKeyboardView,
            touchgfx::meta::TypeList< ScreenTableView,
            touchgfx::meta::TypeList< ScreenTableSettingsView,
            touchgfx::meta::TypeList< ScreenTableSettings_1View,
    ...
    typedef touchgfx::meta::TypeList< Screen1Presenter,
            touchgfx::meta::TypeList< ScreenSettingsPresenter,
            touchgfx::meta::TypeList< ScreenKeyboardPresenter,
            touchgfx::meta::TypeList< ScreenTablePresenter,
            touchgfx::meta::TypeList< ScreenTableSettingsPresenter,
            touchgfx::meta::TypeList< ScreenTableSettings_1Presenter,
