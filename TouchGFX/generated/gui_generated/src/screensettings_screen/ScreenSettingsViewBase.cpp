    ...
    flexButtonCallback(this, &ScreenSettingsViewBase::flexButtonCallbackHandler)
{
    ...
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_XY8W));
    ...
    buttonWithLabelOk.setLabelText(touchgfx::TypedText(T___SINGLEUSE_0I27));
    ...
    buttonWithLabelCancel.setLabelText(touchgfx::TypedText(T___SINGLEUSE_N999));
    ...
    textArea2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_KSRP));

    textArea3.setXY(86, 148);
    textArea3.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea3.setLinespacing(0);
    textArea3.setTypedText(touchgfx::TypedText(T___SINGLEUSE_Y032));
    ...
    textAreaPw.setTypedText(touchgfx::TypedText(T___SINGLEUSE_CWWN));
    ...
    textAreaSsid.setTypedText(touchgfx::TypedText(T___SINGLEUSE_4HBC));
